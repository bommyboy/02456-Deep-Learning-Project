...
path_to_enhance="home/tester/bokleong/dl_project_eval/DeepFilterNet/models/AugNet/./denoise"
...
output_dir="${data_dir}/enhanced_augnet"

# Read options
echo Enhancing run${run}
...
do
    ...
    do  
        ...
        /${path_to_enhance} ${noisy_file_dir}/noisy${num}_SNRdb_${snr}_clnsp${num}.wav ${output_dir}/noisy${num}_SNRdb_${snr}_clnsp${num}_augnet.wav
    done
done